                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="md:hidden">
                        <Button
                            ...
                            className="inline-flex items-center justify-center p-2 rounded-md text-foreground/80 hover:text-primary hover:bg-white/10 transition-colors duration-200"
                        >
