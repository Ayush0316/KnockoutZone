...
import { FaHome, FaEye, FaCalendarCheck, FaInfoCircle, FaSignOutAlt } from "react-icons/fa"
...
const Sidebar = ({ isMobileMenuOpen }) => {
    ...
    ${isMobileMenuOpen ? 'flex' : 'hidden md:flex'} flex-col justify-between mb-4 md:mb-0 md:mr-6 p-4 md:p-6 text-white shadow-lg`}
        >
            ...
            {/* Top Section */}
            <div>
                <h2 className="text-2xl font-bold mb-8">Guest Panel</h2>

                <ul className="space-y-4 text-base md:text-lg">
                    {[
                         { icon: <FaHome />, label: "Home" },
                        { icon: <FaEye />, label: "View Tournaments" },
                        { icon: <FaCalendarCheck />, label: "Match Schedule" },
